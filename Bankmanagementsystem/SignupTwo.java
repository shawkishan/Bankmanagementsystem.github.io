...
public class SignupTwo extends JFrame implements ActionListener {
    ...
    SignupTwo(String formno) {
        ...
        setLayout(null);
        setTitle("New account applcation from Page 2");
        ...
        String occupationValues[] = { "Salaried", "Self-Empoyed", "Bussiness", "Student", "Retired", "Other" };
    ...
    public void actionPerformed(ActionEvent ae) {
        ...
        try {
            ...
            String query = "insert into signuptwo values('" + formno + "','" + sreligion + "','" + scategory + "','" + sincome
                    + "','" + seducation + "','" + soccupation + "','" + span + "','" + saadhar + "','" + seniorcitizen  + "','" + exisitingaccount + "')";
